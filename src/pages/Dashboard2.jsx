      ...
      >
        ...
        <nav className="flex-1 space-y-2 cursor-pointer">
          {["Dashboard", "Cards", "Activity", "Insights"].map((label) => (
            <motion.div key={label} variants={sideItemVariants}>
              <NavItem
                label={label}
      ...
      <main className="flex-1 p-4 md:p-8 overflow-y-auto md:ml-64">
        ...
        >
          ...
          <div className="flex items-center gap-3 ml-auto">
            <motion.button
              className="p-2 text-slate-500 bg-white rounded-lg shadow-sm"
            >
              <svg
                width="20"
                height="20"
        ...
        <div className="flex flex-col gap-6">
          ...
          <motion.div
            variants={itemVariants}
            className="bg-white rounded-[15px] p-6 md:p-8 shadow-sm"
          >
